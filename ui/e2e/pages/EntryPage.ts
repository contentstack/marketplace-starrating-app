...
export class EntryPage {
  ...
  async validateCustomField(appName: string) {
    const starRating = this.getFrame(appName).locator('span.react-simple-star-rating').first()
  ...
  getStarRating(appName: string): Locator {
    return this.getFrame(appName)
      .locator('span.react-simple-star-rating')
      .first();
  }
